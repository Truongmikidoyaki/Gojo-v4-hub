...
if game:GetService("CoreGui"):FindFirstChild("GojoHub") then
    game:GetService("CoreGui"):FindFirstChild("GojoHub"):Destroy()
end
...
function Update:Window(text,logo,keybind)
    ...
    local GojoHub = Instance.new("ScreenGui")
    GojoHub.Name = "GojoHub"
    GojoHub.Parent = game.CoreGui
    GojoHub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
local Library = Update:Window("Gojo Hub","",Enum.KeyCode.RightControl);
...
local kataJackpot = {"Truongdepzai Gojo", "sonicturu Gojo", "Truongdepzai Gojo", " SonicTuru Gojo"}
...
loadingText.Name = "Gojo Text"
loadingText.Text = "GojoHub"
